    ...
    <div className='min-h-screen flex items-center justify-center w-10/12 m-auto'>
      <div className='hidden md:flex md:w-1/2 p-8'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 500 500'>
          <g id='freepik--background-complete--inject-63' className='w-full rounded-lg shadow-lg'>
            <path
            ...
            <path
              ...
              style={{ fill: '#ebebeb' }}
            />
            <path d='M206.71,98.4a1.33,1.33,0,1,1-1.33-1.33A1.34,1.34,0,0,1,206.71,98.4Z' style={{ fill: '#f5f5f5' }} />
            <circle
              cx='207.14'
              cy='415.38'
              r='7.35'
          ...
          <g id='freepik--Planets--inject-63'>
            <g style={{ opacity: '0.30000000000000004' }}>
              <path d='M201,145.62a1.87,1.87,0,1,1-1.86-1.87A1.86,1.86,0,0,1,201,145.62Z' style={{ fill: '#407BFF' }} />
              <circle cx='72.97' cy='216.13' r='1.32' style={{ fill: '#407BFF' }} />
              <circle cx='291.05' cy='408.33' r='1.89' style={{ fill: '#407BFF' }} />
              <circle cx='336.5' cy={332} r='1.32' style={{ fill: '#407BFF' }} />
              <path
                d='M424.17,95.62a1.32,1.32,0,1,1-1.32-1.32A1.32,1.32,0,0,1,424.17,95.62Z'
                style={{ fill: '#407BFF' }}
              />
              <path d='M172.75,69a1.32,1.32,0,1,1-1.32-1.32A1.33,1.33,0,0,1,172.75,69Z' style={{ fill: '#407BFF' }} />
              <circle cx='277.7' cy='136.94' r='1.32' style={{ fill: '#407BFF' }} />
            </g>
            <circle cx='141.23' cy='116.36' r='21.91' style={{ fill: '#407BFF' }} />
            <circle cx='141.23' cy='116.36' r='21.91' style={{ fill: '#fff', opacity: '0.7000000000000001' }} />
            <path
            ...
            />
            <path d='M131.5,105.62a2,2,0,1,1-2-2A2,2,0,0,1,131.5,105.62Z' style={{ fill: '#407BFF', opacity: '0.2' }} />
            <path
          ...
          <g id='freepik--Rocket--inject-63'>
            <path
              ...
              style={{ opacity: '0.2' }}
            />
            <path d='M133.39,310l17.5,17.5,49-46.17C183,274.88,150.16,293.19,133.39,310Z' style={{ fill: '#263238' }} />
            <path
            ...
            />
            <circle cx='222.2' cy='282.18' r='12.9' style={{ fill: '#fff' }} />
            <circle cx='222.2' cy='282.18' r='8.29' style={{ fill: '#407BFF' }} />
            <polygon
